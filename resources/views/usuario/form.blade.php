<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="fechaNacimiento" type="date" class="datepicker form-control @error('fechaNacimiento') is-invalid @enderror" name="fechaNacimiento" value="{{ $usuario->fechaNacimiento }}" required>
